...
<div class="p-3">
  <div class="three mb-3 d-flex justify-content-between align-items-center">
    ...
    <a type="button" class="btn btn-secondary py-2" href="{{ route('Complaints.index') }}">الشكاوي</a>
  </div>
        ...
        <tbody>
          ...
          @foreach ($complaints as $complaint)
           <tr>
            ...
            <td><p class="ms-5" style="inline-size: 9rem; overflow-wrap: break-word">{{$complaint->last_name}}</p></td>
            <td><p class="ms-5" style="inline-size: 7rem; overflow-wrap: break-word">{{($complaint->created_at)->format('d/m/Y   h:i:s')}}</p></td>
            <td>
              <a class="btn btn-primary ms-1 py-1" href="{{ route('Complaints.restore', $complaint->id) }}">استرجاع</a>
              <a class="btn btn-danger ms-1 py-1" href="{{ route('Complaints.hard_delete', $complaint->id) }}">حذف نهائي</a>  
            </td>
           </tr>
