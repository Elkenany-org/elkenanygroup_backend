                    ...
                    <div class="col-12">
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                          ...
                          <input type="text" class="form-control" name="social_description" value="{{$job->social_description}}">
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="input-style-1">
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                          ...
                          <input type="text" class="form-control" name="meta_link" value="{{$job->meta_link}}">
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                          ...
                          <input type="text" class="form-control" name="meta_description" value="{{$job->meta_description}}">
                        </div>
                      </div>
                    <div class="col-12">
